...
/**
 * The implementation of the SMART asymmetric client authentication method.
 *
 * @see <a
...
public class AsymmetricClientAuthMethod extends ClientAuthMethod {
  ...
  @Nonnull JWK privateKey;

  @Nullable @Builder.Default String scope = null;
  ...
  public static class AsymmetricClientAuthMethodBuilder {
    ...
    /**
     * Sets the private key from JWK format string.
     *
  ...
  protected List<BasicNameValuePair> getAuthParams(@Nonnull final Instant now) {
    ...
    return List.of(
        new BasicNameValuePair(PARAM_CLIENT_ASSERTION_TYPE, CLIENT_ASSERTION_TYPE_JWT_BEARER),
